                ...
                <div class="nk-block-between-md">
                    <div class="nk-block-head-content">
                        ...
                        <div class="nk-wgwh">
                            ...
                            <div class="nk-wgwh-title h5"> Bitcoin Wallet <small>/</small>
                                <div class="dropdown">
            ...
            <div class="nk-block nk-block-lg">
                <div class="row g-gs">
                    <div class="col-12">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <canvas class="chart-account-summary" id="marketCapChart"></canvas>
                            </div><!-- .nk-ck2 -->
                        </div>
                    </div>
                </div><!-- .row -->
...
@section('script')
    <script type="text/javascript">
        var coin_symbol = "<?php echo $coin_symbol;?>";
    </script>
    ...
    <script src="{{asset_url('assets/js/walletView.js?ver=2.2.0')}}"></script>
@endsection
