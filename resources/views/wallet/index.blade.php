                ...
                <div class="row g-gs">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-6 col-xxl-4">
                        <div class="card card-bordered">
                            <div class="nk-wgw">
                                <div class="nk-wgw-inner">
                                    <a class="nk-wgw-name" href="{{url('wallet/ETH')}}">
                                        <div class="nk-wgw-icon">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-6 col-xxl-4">
                        <div class="card card-bordered">
                            <div class="nk-wgw">
                                <div class="nk-wgw-inner">
                                    <a class="nk-wgw-name" href="{{url('wallet/USDT')}}">
                                        <div class="nk-wgw-icon">
                                            <em class="icon ni ni-sign-usdt"></em>
                                        </div>
                                        <h5 class="nk-wgw-title title">Tether Wallet</h5>
                                    </a>
                                    <div class="nk-wgw-balance">
                                        <div class="amount">4.434953<span class="currency currency-btc">USDT</span></div>
                                        <div class="amount-sm">28,247.63<span class="currency currency-usd">USD</span></div>
                                    </div>
                                </div>
                                <div class="nk-wgw-actions">
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-6 col-xxl-4">
                        <div class="card card-bordered">
                            <div class="nk-wgw">
                                <div class="nk-wgw-inner">
                                    <a class="nk-wgw-name" href="{{url('wallet/XRP')}}">
                                        <div class="nk-wgw-icon">
                                            <em class="icon ni ni-sign-xrp"></em>
                                        </div>
                                        <h5 class="nk-wgw-title title">XRP Wallet</h5>
                                    </a>
                                    <div class="nk-wgw-balance">
                                        <div class="amount">4.434953<span class="currency currency-btc">XRP</span></div>
                                        <div class="amount-sm">28,247.63<span class="currency currency-usd">USD</span></div>
                                    </div>
                                </div>
                                <div class="nk-wgw-actions">
