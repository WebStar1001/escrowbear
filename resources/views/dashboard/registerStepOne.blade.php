                        ...
                        <div class="card-inner card-inner-lg">
                            <div class="nk-kyc-app p-sm-2 text-center">
                                ...
                                <div class="nk-kyc-app-action">
                                    <a href="{{route('register-step-two')}}" class="btn btn-lg btn-primary">Click here to complete your KYC</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center pt-4">
                        <p>If you have any question, please contact our support team <a href="mailto:escrowbear@gmail.com">escrowbear@gmail.com</a></p>
                    </div>
                </div><!-- nk-block -->
            </div><!-- kyc-app -->
        </div>
