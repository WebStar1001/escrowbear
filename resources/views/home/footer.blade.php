<footer class="d-flex flex-column">
    <div class="w-100 d-flex mb-3 justify-content-between justify-content-xxl-start">
        ...
        <div>
            ...
            <div class="footer_sec_row d-flex flex-column align-items-start">
                <div class="whatsapp_info mb-5 mt-2">
                    <div>
                        <p class="title">Europe Hotline</p>
                        <p class="description mt-2">+447441429762</p>
                    </div>
                    ...
                    <div class="dropup">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            <ul class="language-list">
                                ...
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="{{asset_url('dashlite/images/flags/turkey.png')}}" alt="" class="language-flag">
